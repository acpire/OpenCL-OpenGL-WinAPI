...
public:
	...
	cl_bool readBuffers(void** returnedData, cl_uint* indicesReadData, cl_uchar* typeArgubentsReturnedData, cl_ulong* lengthWrite, cl_uint numberIndicesReadData);
	cl_bool readBuffer(void* returnedData, cl_uint indicesReadData, cl_ulong lengthWrite);
	...
	void callOpenclFunction(size_t index_kernel, cl_uint* indices_images, cl_uint* indices_buffers, cl_char* indices_arguments, cl_int* size_indices_arguments, size_t number_images, size_t number_buffers, size_t number_arguments);
	void callOpenclFunction(size_t index_kernel, cl_uint* indices_images, cl_uint* indices_buffers, cl_char* indices_arguments, cl_int* size_indices_arguments, size_t number_images, size_t number_buffers, size_t number_arguments, size_t x_work, size_t y_work, size_t z_work);
